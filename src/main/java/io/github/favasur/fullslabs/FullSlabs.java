...
/**
 * Shared FullSlabs bootstrap used by the NeoForge and Fabric 1.21.1 adapters.
 *
 * <p>The 1.21.1 port is a pure graft: the vertical-slab capability is applied directly to every
