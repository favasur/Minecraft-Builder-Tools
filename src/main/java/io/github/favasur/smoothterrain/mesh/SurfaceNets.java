...
import static io.github.favasur.smoothterrain.mesh.SurfaceNets.Lookup.CUBE_EDGES;
import static io.github.favasur.smoothterrain.mesh.SurfaceNets.Lookup.EDGE_TABLE;

/**
 * Surface Nets generates a vertex for each cell and then stitches them together.
 * Written by Mikola Lysenko (C) 2012
 * Ported from JavaScript to Java and modified for SmoothTerrain by Cadiboo.
 *
