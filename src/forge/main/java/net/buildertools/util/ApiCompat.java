...
public final class ApiCompat {
	...
	private static boolean destroyBlockEffect;
	...
	private static boolean mouseHandlerV1;
	private static boolean guiRenderV1;
	...
	public static boolean destroyBlockEffect() {
		check();
	...
	public static boolean mouseHandlerV1() {
		check();
		return mouseHandlerV1;
	}

	public static boolean guiRenderV1() {
		check();
		return guiRenderV1;
	}
	...
	private static synchronized void check() {
		...
		destroyBlockEffect = hasMethod("net.minecraft.client.multiplayer.ClientLevel", "addDestroyBlockEffect", 2);
		weatherMethod = hasMethod("net.minecraft.world.level.block.WeatheringCopper", "method_34740", -1);
		honeycombMethod = hasMethod("net.minecraft.world.item.HoneycombItem", "method_34723", -1);
		...
		mouseHandlerV1 = hasMethod("net.minecraft.client.MouseHandler", "onPress", 4)
				&& hasMethod("net.minecraft.client.MouseHandler", "onScroll", 2);
		guiRenderV1 = hasMethod("net.minecraft.client.gui.Gui", "render", 2);
