...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(net.minecraft.core.registries.Registries.ITEM, BuilderToolsMod.MODID);
    ...
    public static final RegistryObject<Item> BRUSH_PROXY = ITEMS.register("builder_brush",
