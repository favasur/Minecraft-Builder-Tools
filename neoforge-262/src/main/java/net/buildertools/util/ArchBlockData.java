...
public record ArchBlockData(double ox, double oy, double oz,
    ...
    /** Codec for the 26.2 Codec-based saved data (12 doubles in fixed order). */
    public static final Codec<ArchBlockData> CODEC = Codec.DOUBLE.listOf().xmap(
            l -> new ArchBlockData(
            ...
            a -> java.util.List.of(
                    ...
                    a.ux(), a.uy(), a.uz(),
                    a.wx(), a.wy(), a.wz(),
                    a.thetaStart(), a.deltaTheta(), a.radius()));
