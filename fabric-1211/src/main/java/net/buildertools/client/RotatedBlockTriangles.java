...
public final class RotatedBlockTriangles {
    ...
    private static void addQuad(List<MeshCollisionShape.Tri> tris,
        ...
        double x0 = Float.intBitsToFloat(v[0]) + ox;
        double y0 = Float.intBitsToFloat(v[1]) + oy;
        double z0 = Float.intBitsToFloat(v[2]) + oz;
        double x1 = Float.intBitsToFloat(v[8]) + ox;
        double y1 = Float.intBitsToFloat(v[9]) + oy;
        double z1 = Float.intBitsToFloat(v[10]) + oz;
        double x2 = Float.intBitsToFloat(v[16]) + ox;
        double y2 = Float.intBitsToFloat(v[17]) + oy;
        double z2 = Float.intBitsToFloat(v[18]) + oz;
        double x3 = Float.intBitsToFloat(v[24]) + ox;
        double y3 = Float.intBitsToFloat(v[25]) + oy;
        double z3 = Float.intBitsToFloat(v[26]) + oz;
