...
/**
 * Forge adapter for the canonical Smooth Terrain runtime settings. Forge 65.1.1 has no
 * {@code net.neoforged.bus.api.IEventBus}/{@code net.neoforged.fml.ModContainer}, so the
 * registration hook is argument-free and the mod entrypoint calls it directly.
 */
