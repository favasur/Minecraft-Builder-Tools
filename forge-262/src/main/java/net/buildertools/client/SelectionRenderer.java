 ...
 * </ul>
 * Gizmos use absolute world coordinates, so no camera math is needed.
 */
public final class SelectionRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    /** Added to the debug renderer list by {@link net.buildertools.mixin.DebugRendererMixin}. */
    public static SelectionRenderer instance() {
        return INSTANCE;
    }
